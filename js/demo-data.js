/* ============================================================ */
/* PETCARE v3.0 — DEMO DATA (RICHEST v2)                         */
/* Premium realistic dataset · Zero fake feel                    */
/* 3 pets · 50+ logs · 15 posts · Full history · Real SOS        */
/* ============================================================ */
...
const DEMO_DATA = {
  ...
  /* ============================================================ */
  /* 3. HEALTH LOGS — 50+ entries across 3 pets                    */
  /* ============================================================ */
  healthLogs: [
    /* ---------- LUNA (18 entries) ---------- */
  ...
  medications: [
    {
      ...
      nextDose: 'Tomorrow · 8:00 PM · After meal',
      nextDoseDate: new Date(Date.now() + 86400000).toISOString().slice(0, 10),
      nextDoseTime: '20:00',
      note: 'After meal',
    ...
    },
    {
      id: 'demo_med_2',
      petId: 'demo_pet_luna',
      name: 'Hairball Remedy',
      nextDose: 'Friday · 9:00 AM · With breakfast',
      nextDoseDate: new Date(Date.now() + 2 * 86400000).toISOString().slice(0, 10),
      nextDoseTime: '09:00',
      note: 'With breakfast',
      date: new Date().toISOString()
    },
    {
      ...
      nextDose: 'Next Monday · 10:00 AM · With food',
      nextDoseDate: new Date(Date.now() + 3 * 86400000).toISOString().slice(0, 10),
      nextDoseTime: '10:00',
      note: 'With food',
      date: new Date().toISOString()
    },
    {
      ...
      nextDose: 'Monthly · 1st of month',
      nextDoseDate: new Date(Date.now() + 5 * 86400000).toISOString().slice(0, 10),
      nextDoseTime: '08:00',
      note: 'Monthly dose',
      date: new Date().toISOString()
    },
    {
      id: 'demo_med_5',
      petId: 'demo_pet_bella',
      name: 'Kitten Vitamins',
      nextDose: 'Daily · 7:00 AM',
      nextDoseDate: new Date(Date.now() + 1 * 86400000).toISOString().slice(0, 10),
      nextDoseTime: '07:00',
  ...
  /* ============================================================ */
  /* 7. DAILY CARE — Multi-pet state (with REAL streak history)    */
  /* ============================================================ */
  dailyCare: {
    _multi: true,
    demo_pet_luna: {
  ...
  /* ============================================================ */
  /* 8. CARE HISTORY — 14 days of realistic streak data            */
  /* ============================================================ */
  careHistory: (function() {
    ...
    for (let i = 0; i < 14; i++) {
      ...
      history.demo_pet_luna[key] = {
        ...
        water: true,
        walk: true,
        medicine: i > 0, // today medicine pending
        grooming: i % 2 === 0,
        exercise: i % 3 !== 0,
  ...
  /* ============================================================ */
  /* 9. CUSTOM CARE — User-created items per pet                   */
  /* ============================================================ */
  customCare: {
    demo_pet_luna: [
  ...
  /* ============================================================ */
  /* 10. ORDERS — 8 orders at various stages                       */
  /* ============================================================ */
  orders: [
    {
      id: 'ORD-884521',
      ...
      items: [
        { id: 'food7', name: 'Whiskas', price: 14.99, qty: 2 },
        { id: 'acc4', name: 'Dog & Cat Bowls', price: 18.99, qty: 1 }
      ],
      itemsCount: 3,
      total: 55.97,
      name: "Ayesha Khan",
    ...
    },
    {
      ...
      items: [
        { id: 'food10', name: 'Pedigree', price: 22.99, qty: 1 },
        { id: 'acc6', name: 'Dog Toothbrush', price: 8.99, qty: 1 }
      ],
      itemsCount: 2,
      total: 36.98,
      name: "Ayesha Khan",
    ...
    },
    {
      ...
      items: [
        { id: 'acc3', name: 'Pet Carrier', price: 55.99, qty: 1 }
      ],
      itemsCount: 1,
      total: 60.99,
      name: "Ayesha Khan",
    ...
    },
    {
      ...
      items: [
        { id: 'food5', name: 'Viva For Cats', price: 34.99, qty: 1 },
        { id: 'food6', name: 'Me-O', price: 12.99, qty: 2 },
        { id: 'acc5', name: 'Pet Hair Comb', price: 14.99, qty: 1 }
      ],
      itemsCount: 4,
      total: 75.96,
      name: "Ayesha Khan",
    ...
    },
    {
      ...
      items: [
        { id: 'food1', name: 'Royal Canin Adult Cat Food', price: 24.99, qty: 1 },
        { id: 'acc7', name: 'Pet Grooming Kit', price: 39.99, qty: 1 }
      ],
      itemsCount: 2,
      total: 69.98,
      name: "Ayesha Khan",
    ...
    },
    {
      ...
      items: [
        { id: 'acc10', name: 'Licking Mat', price: 13.99, qty: 2 },
        { id: 'acc8', name: 'Paw Balm', price: 11.99, qty: 1 }
      ],
      itemsCount: 3,
      total: 39.97,
      name: "Ayesha Khan",
    ...
    },
    {
      ...
      items: [
        { id: 'food2', name: 'Skyler Treats Herring', price: 24.99, qty: 2 }
      ],
      itemsCount: 2,
      total: 49.98,
      name: "Ayesha Khan",
    ...
    },
    {
      ...
      items: [
        { id: 'acc1', name: 'Pet Spa Set', price: 45.99, qty: 1 },
        { id: 'acc2', name: 'Pet Nail Cutter', price: 12.99, qty: 1 }
      ],
      itemsCount: 2,
      total: 58.98,
      name: "Ayesha Khan",
  ...
  appointments: [
    ...
    },
    {
      ...
      fee: 25,
      reason: 'Follow-up on limping issue',
      status: 'confirmed',
      createdAt: new Date().toISOString()
    },
    {
    ...
    },
    {
      ...
      consultationType: 'inPerson',
      fee: 50,
      reason: 'First vaccine visit — completed',
      status: 'completed',
      createdAt: new Date().toISOString()
    },
    {
      ...
      consultationType: 'inPerson',
      fee: 50,
      reason: 'Annual checkup — clean bill',
      status: 'completed',
      createdAt: new Date().toISOString()
    },
    {
  ...
  /* ============================================================ */
  /* 12. SOS HISTORY — Real emergency reports                      */
  /* ============================================================ */
  sosHistory: [
    {
      id: 'sos_demo_1',
  ...
  notifications: [
    {
      ...
      type: 'order',
      title: '🚚 Order Shipped',
      message: 'Your order ORD-884521 is out for delivery. Arriving today!',
    ...
    },
    {
      ...
      message: "Luna's checkup with Dr. Ayesha is in 3 days.",
    ...
    },
    {
      ...
      message: 'Distemper booster is due on Dec 15. Book soon!',
    ...
    },
    {
      id: 'demo_notif_4',
      type: 'social',
      title: '❤️ Dr. Karim liked your post',
      message: 'Your post "Luna\'s first day at the beach" just hit 50 likes!',
    ...
    },
    {
      ...
      type: 'sos',
      title: '✅ SOS Resolved',
      message: 'Emergency report sos_demo_1 has been successfully resolved. Thank you!',
    ...
    },
    {
      ...
      message: 'Time for Max\'s joint supplement. Don\'t forget!',
    ...
    },
    {
      ...
      type: 'social',
      title: '💬 New Comment',
      message: 'Dr. Ayesha replied to your question about cat nutrition.',
      date: new Date(Date.now() - 1 * 86400000).toISOString(),
      read: true
    },
    {
      ...
      message: 'Explore all features. We\'re here whenever you need us.',
    ...
    },
    {
      ...
      message: 'Your order ORD-884520 was delivered successfully.',
      date: new Date(Date.now() - 3 * 86400000).toISOString(),
      read: true
    }
  ],
  ...
  cart: [
    {
      ...
      name: 'Whiskas',
      price: 14.99,
      img: 'assets/products/whiskas.jpg',
      quantity: 1
    },
    {
      id: 'acc5',
      name: 'Pet Hair Comb',
      price: 14.99,
      img: 'assets/products/accessories5.jpg',
      quantity: 1
    }
  ],
  ...
  /* ============================================================ */
  /* 17. USER CREATED STORE (for demo user)                        */
  /* ============================================================ */
  userStore: {
...
console.log('PetCare Demo Data loaded — RICHEST dataset ready');
console.log('📊 Stats: 3 pets · 48 logs · 12 vaccines · 8 reminders · 8 orders · 10 posts');