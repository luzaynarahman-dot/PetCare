...
function handleGoogleSignIn() {
  const demoGoogleUser = {
    name: 'Luzayna Rahman',
    email: 'luzayna.demo@gmail.com',
    phone: null
  };

  const user = buildNewUser(demoGoogleUser);
  user.avatar = 'https://lh3.googleusercontent.com/a/default-user';

  const token = 'google_mock_' + Date.now();
