...
/* 7. FOSTER PETS */
/* ============================================================ */
/* RESCUE ORGANIZATIONS — Verified orgs                          */
/* ============================================================ */
const RESCUE_ORGS = [
  {
    id: 'org_rescue_bd',
    name: 'Animal Rescue BD',
    type: 'verified_rescue',
    verified: true,
    ...
    rescuedCount: 234,
    responseTime: '4h avg',
    description: 'Dedicated to rescuing, rehabilitating, and rehoming street animals in coastal Bangladesh.',
    verifiedAt: '2022-03-15T00:00:00.000Z'
  },
  {
    id: 'org_dhaka_pets',
    ...
    rescuedCount: 512,
    responseTime: '2h avg',
    description: '24/7 emergency response team for injured and abandoned animals.',
    verifiedAt: '2020-06-01T00:00:00.000Z'
  },
  {
    id: 'org_coastal_care',
    ...
    rescuedCount: 178,
    responseTime: '6h avg',
    description: 'Coastal area rescue and rehabilitation for abandoned pets.',
    verifiedAt: '2021-09-20T00:00:00.000Z'
  }
];

/* ============================================================ */
/* FOSTER PETS — Real structure                                  */
/* ============================================================ */
const FOSTER_PETS = [
  {
    id: 'foster_001',
    ...
    ageMonths: 2,
    image: 'assets/pets/milo.png',
    gallery: ['assets/pets/milo.png'],
    description: 'Milo was found alone on the street near Kolatoli Beach. He is playful, friendly, and loves cuddles. He needs a loving foster home urgently as the shelter is at capacity.',
    medical: {
      vaccinated: true,
      dewormed: true,
      neutered: false,
      healthy: true,
      specialNeeds: false,
      notes: 'Fully healthy. First vaccination done. Needs second dose in 2 weeks.'
    },
    ...
    views: 234,
    status: 'available',
    listedBy: 'org_rescue_bd',       // ⭐ Reference to RESCUE_ORGS
    listedAt: new Date(Date.now() - 1 * 86400000).toISOString(),
    applications: [],                 // ⭐ Application list
    donatedBy: []                     // ⭐ Donor list
  },
  {
    id: 'foster_002',
    name: 'Bella',
    ...
    age: '1 year',
    ageMonths: 12,
    image: 'assets/pets/bella.png',
    gallery: ['assets/pets/bella.png'],
    description: 'Bella is a gentle rescue cat who is ready for a foster family. She is calm, affectionate, and gets along well with other pets.',
    medical: {
      vaccinated: true,
      dewormed: true,
      neutered: true,
      healthy: true,
      specialNeeds: false,
      notes: 'Fully vaccinated and spayed. Perfect health.'
    },
    location: "Sugandha Beach Point, Cox's Bazar",
    distance: '1.5 km',
    fosterDuration: '1-2 months',
    monthlyCost: 30,
    donationsReceived: 78,
    donationGoal: 150,
    views: 156,
    status: 'available',
    listedBy: 'org_rescue_bd',
  ...
  },
  {
    ...
    age: '3 months',
    ageMonths: 3,
    image: 'assets/pets/rocky.png',
    gallery: ['assets/pets/rocky.png'],
    description: 'Rocky was found injured near Marine Drive. He has a small leg injury that needs care. He is very sweet and gentle despite his pain.',
    medical: {
      vaccinated: false,
      dewormed: false,
      neutered: false,
      healthy: false,
      specialNeeds: true,
      notes: 'Leg injury under treatment. Needs daily medication for 10 days.'
    },
  ...
  },
  {
    ...
    gallery: ['assets/pets/luna.png'],
    description: 'Luna is a beautiful Persian mix who was surrendered by her previous owner. She is shy but very sweet once she warms up.',
    medical: {
      vaccinated: true,
      dewormed: true,
      neutered: false,
      healthy: true,
      specialNeeds: false,
      notes: 'Healthy. Needs spaying when age-appropriate.'
    },
    location: "Himchari Road, Cox's Bazar",
    distance: '3.4 km',
    fosterDuration: '1 month',
    monthlyCost: 28,
    donationsReceived: 34,
    donationGoal: 100,
    views: 89,
    status: 'available',
    listedBy: 'org_coastal_care',
    listedAt: new Date(Date.now() - 8 * 86400000).toISOString(),
    applications: [],
    donatedBy: []
  },
  {
    ...
    age: '4 months',
    ageMonths: 4,
    image: 'assets/pets/coco.png',
    gallery: ['assets/pets/coco.png'],
    description: 'Coco is an energetic puppy who loves to play. She was found in a market area and needs a foster family with a yard.',
    medical: {
      vaccinated: true,
      dewormed: true,
      neutered: false,
      healthy: true,
      specialNeeds: false,
      notes: 'Healthy puppy. Full of energy!'
    },
    location: "Kalar Mor, Cox's Bazar",
    distance: '1.9 km',
    fosterDuration: '2-3 weeks',
    monthlyCost: 35,
...
/* HELPER FUNCTIONS                                              */
/* ============================================================ */
function getRescueOrgById(id) {
  return RESCUE_ORGS.find(o => o.id === id) || null;
}

function getFosterPetById(id) {
  return FOSTER_PETS.find(p => p.id === id) || null;
}

function getFosterPetsByLister(listerId) {
  return FOSTER_PETS.filter(p => p.listedBy === listerId);
}

function getAvailableFosterPets() {
  return FOSTER_PETS.filter(p => p.status === 'available');
}
...
window.RESCUE_ORGS = RESCUE_ORGS;
window.getRescueOrgById = getRescueOrgById;
window.getFosterPetById = getFosterPetById;
window.getFosterPetsByLister = getFosterPetsByLister;
window.getAvailableFosterPets = getAvailableFosterPets;
